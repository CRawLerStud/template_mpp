...
import app.persistance.implementation.HibernateSecretWordRepository;
...
public class StartRpcServer {
    ...
    public static void main(String[] args) {
        ...
        SecretWordRepository secretWordRepository = new HibernateSecretWordRepository();

        AppServices services = new DefaultAppServer(userRepository, gameRepository, secretWordRepository);
